...
struct FriendIndividualShelfView: View {
        ...
        VStack(spacing: 0){
            ...
            ScrollView(){
                VStack(spacing: 5){
                    ...
                    if (books.count == 0){
                        Text("No books on this shelf").font(.title)
                    }else{
